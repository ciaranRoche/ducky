---
name: review-verdict
description: Review Round 4 - Synthesize findings from all review rounds into a verdict with ghostwriter style
...
Synthesize all findings from the previous rounds into a final review verdict. Apply ghostwriter style to all written output.
