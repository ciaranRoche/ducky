...
- **MCP:** The `writing-samples` MCP server (provided by the `ducky` plugin) connects to a local Qdrant instance for writing style RAG. It's optional but improves ghostwriter output quality.
