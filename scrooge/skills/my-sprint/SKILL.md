...
**Important:** These custom fields are NOT returned by default by MCP tools. When calling `mcp__atlassian__jira_search` or `mcp__atlassian__jira_get_sprint_issues`, you **must** include them in the `fields` parameter:
```
