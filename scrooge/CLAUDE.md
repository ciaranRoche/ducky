...
|----------|------|------|-------|
| `customfield_10028` | Story Points | Number | The story points field for this JIRA instance. Always include in `fields` when querying, always set when creating/updating. |
