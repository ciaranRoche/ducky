...
4. Write the body in ducky-ghostwriter style
...
2. Apply ducky-ghostwriter style to the comment

```bash
gh issue comment $2 --body "[ducky-ghostwriter-styled message]"
```
...
## Notes
- Use ducky-ghostwriter style for any written content (issue bodies, comments)
