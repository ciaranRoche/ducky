...
1. If the request mentions **bug**, **defect**, **broken**, **regression**, or **not working**: invoke **jira-create-bug**
2. If the request mentions **story** or **user story**: invoke **jira-create-story**
3. If the request mentions **task**, **spike**, **tech debt**, **investigate**, or **infrastructure**: invoke **jira-create-task**
4. If the request mentions **epic**: invoke **jira-create-epic**
5. If the request mentions **feature** or **initiative**: invoke **jira-create-feature**
6. If unclear, ask:
...
| Type | Skill | Use For |
|------|-------|---------|
| Bug | `jira-create-bug` | Defects with steps to reproduce, expected/actual behavior |
| Story | `jira-create-story` | User stories with AC and technical notes |
| Task | `jira-create-task` | Tech debt, infrastructure, documentation, spikes |
| Epic | `jira-create-epic` | Scoped body of work with child stories |
| Feature | `jira-create-feature` | Portfolio-level initiative with benefit hypothesis and child epics |
