...
Run the **ducky-review-gates** skill:
...
Run the **ducky-review-design** skill:
...
Run the **ducky-review-correctness** skill:
...
Run the **ducky-review-verdict** skill:
- Synthesize findings from all rounds
- Apply ducky-ghostwriter style to all output
