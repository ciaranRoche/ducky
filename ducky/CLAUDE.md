...
- **Skills vs Agents:** Skills run inline in the conversation. Agents run autonomously. The `ducky-research` skill and `researcher` agent cover the same domain but at different autonomy levels.
